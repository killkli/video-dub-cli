...
on it, and a missing script is a repo layout invariant, not a
runtime condition.
"""
...
def _resolve_vendor_script(filename: str) -> Path:
    ...
    The package lives at ``src/dub/tts_engines/omnivoice/runner.py``;
...
VENDOR_SCRIPT = _resolve_vendor_script("dubbing_batch_tts.py")
